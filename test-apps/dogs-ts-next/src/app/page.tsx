...
import { query, effect, Query, Effect, hook } from "leo-query";
...
export default async function Home(props: { dogs: number }) {
  const dogs = useDogStoreAsync(s => s.dogs, {serverValue: props.dogs});
  return (
    <div className={styles.page}>
      <main className={styles.main}>
        ...
        <ol>
          <li>
            Get started by editing <code>src/app/page.tsx</code>. YAY
          </li>
